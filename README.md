...
**This is not my idea. The project is being developed by WeLoveDevs. The only difference between the original react-ultimate-resume uses javaScript while this uses Typescript. There is no javascript code. Feelfree to use any of codebase.**
